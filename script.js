...
// Email section 
document.getElementById('contact__content').addEventListener('submit', function(event) {
...
document.getElementById('contact-form').addEventListener('submit', function(event) {
  ...
  if (message.value.trim() === "") {
    ...
    messageError.style.display = 'red';
  }
  ...
  (function(){
     emailjs.init("ntombekhayamkaba@gmail.com");  
  })();


  document.querySelector('.contact section').addEventListener('submit', function(event) {
    event.preventDefault();
